...
class nivel3 extends Phaser.Scene{
    constructor() {
     ...
     preload ()
    {
        this.load.image('fondon3', 'img/fondoNivel3.png');
        this.load.image('dulce3', 'img/paleta2.png');
        ...
        this.load.image('rod', 'img/rodilleras.png');
        this.load.image('fuego', 'img/fuego.png');
        ...
        this.load.image('pregunta3', 'img/pregunta3.png');
