...
class nivel2 extends Phaser.Scene{
    constructor() {
     ...
     preload ()
    {
        this.load.image('fondon2', 'img/fondoNivel2.png');
        this.load.image('dulce2', 'img/pastel.png');
        ...
        this.load.image('cas', 'img/casco1.png');
        ...
        if ((dulces2.countActive(true) === 0) && (ban1 == 0))
                    {
                        ...
                        trofeos.create(190,415,"cas");
                        trofeo1.create(650,120,"cas");
                        trofeo2.create(350,255,"cas");
