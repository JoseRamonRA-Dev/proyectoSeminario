...
class nivel2 extends Phaser.Scene{
     ...
     create ()
    {
        ...
        this.fondoN2 = this.add.tileSprite(0,0, config.width, config.height, "fondon2");
        this.fondoN2.setOrigin(0,0);
        this.fondoN2.setScale(1.05);
        ...
        plataformas.create(config.width * 0.15,config.height * 0.30,"rampas");
        plataformas.create(config.width * 0.85,config.height * 0.30,"rampas");
        plataformas.create(config.width * 0.5,config.height * 0.55,"rampas");
        plataformas.create(config.width * 0.25,config.height * 0.80,"rampas");
        plataformas.create(config.width * 0.85,config.height * 0.80,"rampas");
        ...
        if ((dulces2.countActive(true) === 0) && (ban1 == 0))
                    {
                        ...
                        preguntas.create(config.width/2,50,"pregunta2").setScale(1);
                        ...
                        plataformas.create(config.width * 0.15,config.height * 0.30,"nunca");
                        plataformas.create(config.width * 0.85,config.height * 0.30,"casinunca");
                        plataformas.create(config.width * 0.5,config.height * 0.55,"pocasveces");
                        plataformas.create(config.width * 0.25,config.height * 0.80,"muchasveces");
                        plataformas.create(config.width * 0.85,config.height * 0.80,"siempre");
                        //trofeo2 = this.physics.add.create(250,410,"ruedita").setScale(.5);
                        trofeos.create(config.width * 0.15,config.height * 0.24,"cas");
                        trofeo1.create(config.width * 0.85,config.height * 0.24,"cas");
                        trofeo2.create(config.width * 0.5,config.height * 0.49,"cas");
                        trofeo3.create(config.width * 0.25,config.height * 0.74,"cas");
                        trofeo4.create(config.width * 0.85,config.height * 0.74,"cas");
                        jugador.x = 500;
                        jugador.y = 300;
                        //Cuando chocab
